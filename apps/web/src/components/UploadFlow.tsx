                ...
                <ConsentRow
                  ...
                  label={
                    <>
                      ...
                      этот файл и использовать его через сервис в личных целях, что
                      я несу ответственность за законность загрузки, и принимаю{" "}
                      <Link className="lnk" href="/legal/upload">
                        Условия загрузки произведения
                      </Link>
                      , включая предоставление лицензии на обработку файла.
                    </>
                  }
