    ...
    <div className="screen-fade">
      <div className="container-narrow" style={{ paddingBottom: 96, paddingTop: 56 }}>
        ...
        <Section title="Аккаунт">
          ...
          >
            <strong>Выгрузка</strong> — JSON-файл с вашими данными в сервисе:
            профиль из Google-аккаунта, ваши книги, библиотека, история чатов с
            ассистентом, плюс юридический контекст (оператор, цели обработки,
            подрядчики, сроки, ваши права). Исходные файлы загруженных книг и
            технические логи в выгрузку не входят — запрашиваются на
            privacy@remarka.app.
            <br />
            <br />
