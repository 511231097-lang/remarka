        ...
        <div style={{ marginTop: 18 }}>
          ...
          >
            ...
            <span>
              ...
              . Я согласен на передачу моих идентификационных данных и фрагментов запросов
              компании Google LLC (США) для работы авторизации и ассистента — это трансграничная
              передача персональных данных в страну, не входящую в перечень государств с
              адекватной защитой.
            </span>
          </label>
        </div>
